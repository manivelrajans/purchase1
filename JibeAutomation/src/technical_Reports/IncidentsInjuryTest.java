...
public class IncidentsInjuryTest extends WebDriverPass {
	ExtentReports report;
	ExtentTest test;
	IncidentsInjury i = new IncidentsInjury();
	
  @Test
  public void IncidentsInjuryModule() throws Exception{
	  test=report.startTest("Incidents with Injury");
	  i.IncidentsInjuryIndex(driver);
